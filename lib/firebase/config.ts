...
const firebaseConfig = {
  apiKey: process.env.NEXT_PUBLIC_FIREBASE_API_KEY || 'AIzaSyCx6EvZlp_pX9GaRu_NvCHTa3Tk_k18OU4',
  authDomain: process.env.NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN || 'guide-de-lyon-b6a38.firebaseapp.com',
  projectId: process.env.NEXT_PUBLIC_FIREBASE_PROJECT_ID || 'guide-de-lyon-b6a38',
  storageBucket: process.env.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET || 'guide-de-lyon-b6a38.firebasestorage.app',
  messagingSenderId: process.env.NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID || '173827247208',
  appId: process.env.NEXT_PUBLIC_FIREBASE_APP_ID || '1:173827247208:web:899a74bd3a5a24f1f63fdd'
};
